...
<head>
    ...
    <meta name="description"
        content="Application d'une gestion d'universite">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="<?=base_url()?>/#">
                                <img src="<?=base_url()?>/plugins/images/users/utilisateur.png" alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium">ESCANOR</span></a>
                        </li>
                        <!-- ============================================================== -->
