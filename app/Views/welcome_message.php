...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?=base_url()?>/https://codeigniter4.github.io/userguide/" target="_blank">Docs</a>
            </li>
            <li class="menu-item hidden"><a href="<?=base_url()?>/https://forum.codeigniter.com/" target="_blank">Community</a></li>
            <li class="menu-item hidden"><a
                    href="<?=base_url()?>/https://github.com/codeigniter4/CodeIgniter4/blob/develop/CONTRIBUTING.md" target="_blank">Contribute</a>
            </li>
        </ul>
    </div>
...
<div class="further">
    ...
    <section>
        ...
        <p>The User Guide contains an introduction, tutorial, a number of "how to"
            ...
            the framework. Check the <a href="<?=base_url()?>/https://codeigniter4.github.io/userguide"
